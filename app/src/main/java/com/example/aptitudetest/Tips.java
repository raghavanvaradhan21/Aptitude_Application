...
public class Tips extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=x9smdyp1Tg0");
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=mLD41elDRTE");
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=edEvlh0tqzk");
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=78b4Jn4rw44");
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.nav_home) {
            Intent intent1 = new Intent(Tips.this, MainActivity2.class);
            startActivity(intent1);

        }  else if (item.getItemId() == R.id.nav_home) {
            Intent intent2 = new Intent(Tips.this, MainActivity2.class);
